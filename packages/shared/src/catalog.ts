...
export type PublicProductCard = { id: string; titleZhCn: string; titleEnUs: string | null; storeName: string; storeSlug: string; categoryName: string; brandName: string | null; franchiseName: string | null; priceAmount: number | null; currency: string; inStock: boolean };
