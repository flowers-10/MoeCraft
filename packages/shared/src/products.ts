...
export interface ProductSkuDraft { id?: string; code?: string; nameZhCn: string; nameEnUs?: string; barcode?: string; imageFileId?: string; optionValues: Record<string, string>; weightGrams?: number; lengthMm?: number; widthMm?: number; heightMm?: number; priceAmount: number; currency?: string; initialStock: number }
export interface ProductDraftInput { titleZhCn: string; titleEnUs?: string; descriptionZhCn?: string; descriptionEnUs?: string; categoryId?: string; brandId?: string; franchiseId?: string; characterId?: string; tagIds: string[]; material?: string; scale?: string; manufacturer?: string; copyrightNotice?: string; saleType: ProductSaleType; presaleNotice?: string; shippingWindowStart?: string; shippingWindowEnd?: string; afterSalesSummary?: string; skus: ProductSkuDraft[]; media: ProductMediaDraft[] }
