...
export const ADMIN_ROUTE_PERMISSIONS = [
  ...
  "system.jobs", "commerce.products", "commerce.inventory", "commerce.promotions", "commerce.orders", "commerce.afterSales", "commerce.reports"
] as const;
...
export const MERCHANT_STAFF_ROUTE_PERMISSIONS = ADMIN_ROUTE_PERMISSIONS.filter(
  (permission): permission is Exclude<AdminRoutePermission, `platform.${string}`> => !permission.startsWith("platform.")&&permission!=="system.jobs"
);
