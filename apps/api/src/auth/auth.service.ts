...
export class AuthService {
  ...
  async accessProfile(authorization?: string): Promise<AccessProfile> {
    ...
    if (membership?.role === "OWNER") return { routePermissions: [...ADMIN_ROUTE_KEYS].filter((item) => !item.startsWith("platform.")&&item!=="system.jobs"), buttonPermissions: [...MERCHANT_BUTTON_KEYS] };
