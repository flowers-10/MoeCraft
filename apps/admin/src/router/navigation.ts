...
export const navigationTree: NavigationNode[] = [
  ...
  { id: "platform", label: "nav.platform", icon: "◇", roles: platformRoles, children: [{ id: "onboarding", label: "nav.onboarding", icon: "·", routeName: "onboarding", accessKey: "platform.onboarding", roles: platformRoles }] },
