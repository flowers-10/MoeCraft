...
function fallbackPath(permissions: AdminRoutePermission[]) { const candidates: Array<[AdminRoutePermission,string]>=[["merchant.store","/merchant/store"],["merchant.team","/merchant/team"],["system.overview","/system/overview"],["platform.productReview","/platform/product-reviews"],["platform.catalog","/platform/catalog"],["platform.onboarding","/platform/merchant-applications"],["commerce.products","/commerce/products"],["commerce.promotions","/commerce/promotions"],["commerce.orders","/commerce/orders"]];return candidates.find(([key])=>permissions.includes(key))?.[1]??"/login"; }
