import type { CheckoutQuote, OrderListItem, OrderView, PaymentView, SandboxPaymentResult, ShippingAddressSnapshot } from "@moecraft/shared";
...
export function useOrders(){
  ...
  const quote=(address:ShippingAddressSnapshot,couponCode?:string)=>request<CheckoutQuote>("/checkout/quotes",{method:"POST",body:{address,couponCode:couponCode||undefined}});
  ...
  return{orders,pending,error,list,get,quote,submit,cancel,confirmReceipt,startPayment,payment,closePayment,simulate};
}
